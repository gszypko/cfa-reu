...
#     set foldername="stream_candidates"
...
#     ./angslice.py vr $n --longcolor --filtered --tofile $foldername/$filename/
...
#     ./angslice.py vr $n --longcolor --tofile $foldername/$filename/
# end

# ./angslice.py vr -45 -20 --longcolor --boxcar --tofile fullscan_boxcar/approach1/
# ./angslice.py np -45 -20 --longcolor --boxcar --tofile fullscan_boxcar/approach1/
# ./angslice.py temp -45 -20 --longcolor --boxcar --tofile fullscan_boxcar/approach1/
# ./angslice.py b -45 -20 --longcolor --boxcar --tofile fullscan_boxcar/approach1/

# ./angslice.py np -45 -20 --longcolor --boxcar --tofile boxcar_test/approach1/
# ./angslice.py temp -45 -20 --spiralcolor --spiralslice --filtered --tofile spiralcolor_test/approach1/

./angslice.py vr -10 15 --longcolor --boxcar --tofile fullscan_boxcar/approach2/
./angslice.py np -10 15 --longcolor --boxcar --tofile fullscan_boxcar/approach2/
./angslice.py temp -10 15 --longcolor --boxcar --tofile fullscan_boxcar/approach2/
./angslice.py b -10 15 --longcolor --boxcar --tofile fullscan_boxcar/approach2/

# ./angslice.py vr -45 -20 --spiralcolor --boxcar --tofile boxcar_test/approach1spiral/
# ./angslice.py np -45 -20 --spiralcolor --boxcar --tofile boxcar_test/approach1spiral/
# ./angslice.py temp -45 -20 --spiralcolor --boxcar --tofile boxcar_test/approach1spiral/
# ./angslice.py b -45 -20 --spiralcolor --boxcar --tofile boxcar_test/approach1spiral/
